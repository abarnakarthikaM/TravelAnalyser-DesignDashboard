          ...
          <Row gutter={[24, 24]} style={{ marginBottom: 32 }}>
            <Col xs={24} lg={12}>
              <Card style={{ height: 400 }}>
                ...
                <div style={{ marginTop: 24 }}>
                  <Text style={{ fontWeight: 500, marginBottom: 16, display: 'block' }}>
                    Cost by Violation Severity
                  </Text>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <Text style={{ fontWeight: 600 }}>$67,340</Text>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <Text style={{ fontWeight: 600 }}>$42,180</Text>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <Text style={{ fontWeight: 600 }}>$15,330</Text>
                    </div>
                  </div>
                </div>
              </Card>
            ...
            <Col xs={24} lg={12}>
              <Card style={{ height: 400 }}>
                ...
                <Text style={{ color: '#8c8c8c', display: 'block', marginBottom: 24 }}>
                  Distribution of policy violations by type
                </Text>
                
                {/* Violation types breakdown */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', backgroundColor: '#f9f9f9', borderRadius: 8 }}>
                    <div>
                      <Text style={{ fontWeight: 500, display: 'block' }}>Expense Documentation</Text>
                      <Text style={{ color: '#8c8c8c', fontSize: 12 }}>Missing or incomplete receipts</Text>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <Text style={{ fontWeight: 600, display: 'block' }}>45</Text>
                      <Text style={{ color: '#8c8c8c', fontSize: 12 }}>31.5%</Text>
                    </div>
                  </div>

                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', backgroundColor: '#f9f9f9', borderRadius: 8 }}>
                    <div>
                      <Text style={{ fontWeight: 500, display: 'block' }}>Lodging Limits</Text>
                      <Text style={{ color: '#8c8c8c', fontSize: 12 }}>Exceeded approved limits</Text>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <Text style={{ fontWeight: 600, display: 'block' }}>38</Text>
                      <Text style={{ color: '#8c8c8c', fontSize: 12 }}>26.6%</Text>
                    </div>
                  </div>

                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', backgroundColor: '#f9f9f9', borderRadius: 8 }}>
                    <div>
                      <Text style={{ fontWeight: 500, display: 'block' }}>Advance Booking</Text>
                      <Text style={{ color: '#8c8c8c', fontSize: 12 }}>Late booking violations</Text>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <Text style={{ fontWeight: 600, display: 'block' }}>32</Text>
                      <Text style={{ color: '#8c8c8c', fontSize: 12 }}>22.4%</Text>
                    </div>
                  </div>

                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', backgroundColor: '#f9f9f9', borderRadius: 8 }}>
                    <div>
                      <Text style={{ fontWeight: 500, display: 'block' }}>Preferred Vendors</Text>
                      <Text style={{ color: '#8c8c8c', fontSize: 12 }}>Non-preferred vendor usage</Text>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <Text style={{ fontWeight: 600, display: 'block' }}>28</Text>
                      <Text style={{ color: '#8c8c8c', fontSize: 12 }}>19.6%</Text>
                    </div>
                  </div>
                </div>

                <div style={{ marginTop: 24, padding: 16, backgroundColor: '#f0f9ff', borderRadius: 8, border: '1px solid #e0f2fe' }}>
                  <Text style={{ fontWeight: 500, display: 'block', marginBottom: 4 }}>
                    Most Common Violation
                  </Text>
                  <Text style={{ color: '#0369a1' }}>
                    Expense Documentation issues account for nearly 1/3 of all violations
                  </Text>
                </div>
              </Card>
            </Col>
