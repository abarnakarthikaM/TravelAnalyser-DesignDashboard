...
import { DatePicker, Empty, Layout, Select, Space, Tabs } from "antd";
        ...
        <Content style={{ padding: '32px' }}>
          ...
          <div className="mb-8">
            ...
            {activeTab === "expense-breakdown" && (
              <>
                ...
                {
                  !resExpenseBreakdown.isLoading && resExpenseBreakdown.isSuccess && (resExpenseBreakdown.data as any)?.data?.expense_breakdown ? (
                    resCommonTabResponse_S?.data?.data?.expense_breakdown !== undefined && resCommonTabResponse_S?.data?.data?.expense_breakdown ? (
                      <ExpenseCharts metrics={resCommonTabResponse_S.data.data} />
                    ) : (
                      <Empty className="cls-whole-empty" />
                    )
                  ) : (
            ...
            {(activeTab === "vendor-performance" &&
              (
                <>
                  ...
                  {
                    !loader && resExpenseBreakdown.isLoading ? (
                      <BarChartLoader />
                    ) : resExpenseBreakdown.isSuccess && resCommonTabResponse_S.data?.data?.vendor_performance ? (
            ...
            {(activeTab === "compliance" &&
              (
                <>
                  {resExpenseBreakdown.isSuccess && !resExpenseBreakdown.isLoading ?

                    (resCommonTabResponse_S.data?.data?.compliance !== undefined && resCommonTabResponse_S.data?.data?.compliance ?
                      (
                        <div
          ...
          <div className="grid grid-cols-1 gap-8 mt-8">
            <div className="col-span-2">
              {(resDashboardOverview.isSuccess && resDashboardOverviewData_S?.data?.top_expenses.length > 0) ? <TopExpenses expenses={resDashboardOverviewData_S?.data?.top_expenses} /> : <TableLoader />}
            </div>
  ...
  function VendorPerformanceTab() {
    ...
    return (
      ...
      >
        ...
        {/* Chart area */}
        {selectedVendorTab.length > 0 && selectedVendorTab !== undefined ?
          (
